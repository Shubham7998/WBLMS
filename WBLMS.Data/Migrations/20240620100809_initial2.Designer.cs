...
namespace WBLMS.Data.Migrations
{
    ...
    [Migration("20240620100809_initial2")]
            ...
            modelBuilder.Entity("WBLMS.Models.SuperAdmin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedById = 0,
                            CreatedDate = new DateTime(2024, 6, 20, 15, 38, 8, 787, DateTimeKind.Local).AddTicks(1419),
                            EmailAddress = "hemant.patel@wonderbiz.in",
                            FirstName = "Hemant",
                            GenderId = 2,
                            LastName = "Patel",
                            Password = "DD1C23E4B3AB50A0E5D961C3B93BE469F82E398DD37E3F492281AE069AF743F2:5CAECA767B732FCA3C8A8D0C6C8D82CB:50000:SHA256",
                            UpdatedById = 0,
                            UpdatedDate = new DateTime(2024, 6, 20, 15, 38, 8, 787, DateTimeKind.Local).AddTicks(1428)
                        });
                });
